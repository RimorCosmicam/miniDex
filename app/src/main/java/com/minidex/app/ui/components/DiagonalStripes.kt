...
/**
 * Interleaved diagonal bands, scrolling. The one piece of ornament the language allows, and only
 * on full-screen moments — never behind content you have to read.
 *
 ...
 * it travels, so pulling it genuinely clears the side it was covering. Drawn on nothing rather
 * than over a fill, so what opens up between the halves is whatever is behind it.
 */
@Composable
fun DiagonalStripes(
    travel: Float,
